...
Job.find_or_create_by(title: "Wechat Developer", description: "Frontend  Developer", status: "Waiting for phone interview", rating: 5, application_date: date6, source: "indeed.com", user_id: mia.id)
Job.find_or_create_by(title: "Firework Developer", description: "Backend Developer", status: "In person interview", rating: 5, application_date: date7, source: "indeed.com", user_id: mia.id)
Job.find_or_create_by(title: "TikTok Developer", description: "Frontend Developer", status: "Waiting to hear back", rating: 5, application_date: date8, source: "monster.com", user_id: mia.id)
Job.find_or_create_by(title: "Behance Developer", description: "Backend Developer", status: "Technical Interview", rating: 5, application_date: date9, source: "Glenn", user_id: mia.id)
Job.find_or_create_by(title: "dribbble Developer", description: "Full Stack Developer", status: "Waiting for phone interview", rating: 5, application_date: date10, source: "indeed.com", user_id: mia.id)
...
Job.find_or_create_by(title: "Pinterest Developer", description: "Full Stack Developer", status: "Waiting for phone interview", rating: 5, application_date: date11, source: "indeed.com", user_id: nicole.id)
Job.find_or_create_by(title: "YouTube Software Developer", description: "Full Stack Developer", status: "In person interview", rating: 5, application_date: date12, source: "indeed.com", user_id: nicole.id)
...
Job.find_or_create_by(title: "Google Software Developer", description: "Backend Developer", status: "Technical Interview", rating: 5, application_date: date14, source: "Glenn", user_id: nicole.id)
Job.find_or_create_by(title: "Pinterest Software Developer", description: "Full Stack Developer", status: "Waiting for phone interview", rating: 5, application_date: date15, source: "indeed.com", user_id: nicole.id)
